...
import com.zsct.customer.adapter.SectionAdapter;
import com.zsct.customer.adapter.ShopListAdapter;
import com.zsct.customer.app.MyApplication;
import com.zsct.customer.dao.TypeDao;
		...
		Runnable listRun = new Runnable() {
			...
			public void run() {
				...
				if (MyApplication.getInstance().islocation==1) {
					mPair.add(new BasicNameValuePair(JsonUtil.LAT,PreferenceUtil.getInstance(ShopListActivity.this).getString(PreferenceUtil.LAT, "0")));
					mPair.add(new BasicNameValuePair(JsonUtil.LONG,PreferenceUtil.getInstance(ShopListActivity.this).getString(PreferenceUtil.LON, "0")));
				}

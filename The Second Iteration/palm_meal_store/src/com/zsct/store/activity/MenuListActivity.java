...
public class MenuListActivity extends BaseActivity implements OnRefreshListener {
			...
			case ensure_what:
				try {
					...
					if (sectionindex == 0) {
						...
						adapter = new OrderListAdapter(MenuListActivity.this,
								orderlistdata);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		orderList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View view,
				...
				Intent mIntent = new Intent(MenuListActivity.this,
	...
	private void initRun() {
		// TODO Auto-generated method stub
		uid = PreferenceUtil.getInstance(MenuListActivity.this).getSid();

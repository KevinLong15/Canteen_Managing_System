    ...
    if(roletype == "1"){
    	_menus = {
   	         "menus": [
   	             {"menuid": "1", "icon": "icon-magic", "menuname": "菜品管理",
   	                 "menus": [
   	                     {"menuid": "12", "menuname": "菜品管理列表", "icon": "icon-database", "url": "<%= __APP__%>/Good!good"}
   	                 ]},
   	             {"menuid": "1", "icon": "icon-magic", "menuname": "类别管理",
   	                 "menus": [
   	                     {"menuid": "12", "menuname": "类别列表", "icon": "icon-database", "url": "<%= __APP__%>/Good!type"}
   	                 ]},
   	                 {"menuid": "1", "icon": "icon-magic", "menuname": "窗口管理",
   	                     "menus": [
   	                         {"menuid": "12", "menuname": "窗口列表", "icon": "icon-database", "url": "<%= __APP__%>/Shop!shop"}
   	                     ]},
   	             ...
   	             {"menuid": "56", "icon": "icon-role", "menuname": "用户管理管理",
   	                 "menus": [
    	...
    	_menus = {
   	         "menus": [
   	             {"menuid": "1", "icon": "icon-magic", "menuname": "菜品管理",
   	                 "menus": [
   	                     {"menuid": "12", "menuname": "菜品管理列表", "icon": "icon-database", "url": "<%= __APP__%>/Good!goodshop"}
   	                 ]},
   	             {"menuid": "1", "icon": "icon-magic", "menuname": "类别管理",
   	                 "menus": [
   	                     {"menuid": "12", "menuname": "类别列表", "icon": "icon-database", "url": "<%= __APP__%>/Good!type"}

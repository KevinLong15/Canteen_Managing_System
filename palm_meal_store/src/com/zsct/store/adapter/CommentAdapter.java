...
public class CommentAdapter extends BaseAdapter {
	...
	public CommentAdapter(Context context, ArrayList<Comment> orderlist) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		dl.create_time.setText(data.get(position).getComment_time());
		dl.order_time.setText(data.get(position).getContent());
		return convertView;
	}

			...
			case 4:
    			...
    			try {
					...
					if (json.getInt(JsonUtil.CODE)==1||result3.contains("success")) {
						...
						finish();
						Intent mIntent=new Intent(OrderDealDetailActivity.this,OrderDealDetailActivity.class);
						mIntent.putExtra("orderid", mOrderItem.getOrder_id());
			 ...
			 ThreadPoolManager.getInstance().addTask(new Runnable() {
					...
					public void run() {
						...
						Log.e("hjq", HttpUtil.getURlStr(HttpUtil.URL_GETGROUPBYORDERID, 
			                    new BasicNameValuePair(JsonUtil.ORDER_ID,orderid)));
